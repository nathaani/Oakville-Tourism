...
<body>
    ...
    <main>
        <section>
            <div class="carousel">
                <img class="carousel-image active" src="img/eventArticle/p1.png">
                <img class="carousel-image active" src="img/eventArticle/p2.png">
                <img class="carousel-image active" src="img/eventArticle/p3.png">
                <img class="carousel-image active" src="img/eventArticle/p4.png">
                <img class="carousel-image active" src="img/eventArticle/p5.png">

                <div class="thumbnails">
                    <img src="img/eventArticle/p1.png" class="thumbnail" data-index="0">
                    <img src="img/eventArticle/p2.png" class="thumbnail" data-index="1">
                    <img src="img/eventArticle/p3.png" class="thumbnail" data-index="2">
                    <img src="img/eventArticle/p4.png" class="thumbnail" data-index="3">
                    <img src="img/eventArticle/p5.png" class="thumbnail" data-index="4">
                </div>
            </div>
    ...
    <script src="js/articleCarousel.js"></script>
</body>
